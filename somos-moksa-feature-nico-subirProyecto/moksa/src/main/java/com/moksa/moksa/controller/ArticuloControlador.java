...
public class ArticuloControlador {
	...
	public String articuloRegistrado (@RequestParam String nombrePrenda, @RequestParam Double precio, @RequestParam String telaId, @RequestParam List<String> avioId, @RequestParam String corteId, @RequestParam String confId, @RequestParam Float consumo, MultipartFile archivo) throws ErrorServicio {
