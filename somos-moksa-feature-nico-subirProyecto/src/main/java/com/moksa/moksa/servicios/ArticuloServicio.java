...
public class ArticuloServicio {
	...
	public void validar(String nombre) throws ErrorServicio {
		...
		System.out.println("Nombre Prenda en validar: " + nombre);
...
//	   List<Avio> avioLm = new ArrayList();
//	   for (String avio : avioL) {
//			Avio av=avioRepo.buscarxId(avio);
//			avioLm.add(av);	
//			
//			
//		}
//		prenda.setAvio(avioLm);
