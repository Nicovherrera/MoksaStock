...
public class AvioControlador {
	...
	@GetMapping("/avios")
	public String avio (ModelMap mapaT) {
		
		List<Avio> avioL = avioS.listaAvios();
		
		mapaT.addAttribute("avioL", avioL);
	...
	public String registroAvio (ModelMap mapaA , String nombreAvio, String tipoAvio, Float precio, String proveedor, Integer cantidadCom ) throws ErrorServicio, ParseException {
		
		System.out.println("Avio: "+cantidadCom);
		
		avioS.registroAvio(nombreAvio, tipoAvio, precio, proveedor, cantidadCom);
