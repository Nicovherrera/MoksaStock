...
public class TelaControlador {
	...
	public String registroTela (ModelMap mapaT , @RequestParam String nombreTela, Double cantidadCom, @RequestParam Double precioT, @RequestParam String proveedor, Double rinde) throws ErrorServicio, ParseException {
		
		
		
		System.out.println("Tela: "+nombreTela);
		System.out.println("Precio Tela: "+precioT);
		try {
		telaServicio.registroTela(nombreTela, cantidadCom, precioT, proveedor, rinde);
